<?php
	...
	$site_owners_email = 'Ejemplo@Ejemplo.com'; // Replace this with your own email address
	...
	if (strlen($name) < 2) {
		$error['name'] = "Porfavor, Introduzca su nombre";
	}

	if (!preg_match('/^[a-z0-9&\'\.\-_\+]+@[a-z0-9\-]+\.([a-z0-9\-]+\.)*+[a-z]{2}/is', $email)) {
		$error['email'] = "Porfavor, Introduzca su correo";
	}

	if (strlen($message) < 2) {
		$error['message'] = "Porfavor, Deja un comentario.";
	}
